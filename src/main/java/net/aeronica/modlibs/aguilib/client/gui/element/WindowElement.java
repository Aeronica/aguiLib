...
public class WindowElement<T extends IElementGUI> extends Element<T> {
    ...
    public void render(float mouseX, float mouseY, float partialTicks) {
        ...
        this.startScissor();
        this.drawRectangle(this.getPosX(), this.getPosY(), this.getWidth(), this.getHeight(), AGuiLib.CONFIG.getPrimaryColor());
        this.drawRectangle(this.getPosX(), this.getPosY(), this.getWidth(), 14, AGuiLib.CONFIG.getAccentColor());
        FontRenderer fontRenderer = this.gui.getFontRenderer();
        fontRenderer.drawString(this.name, this.getPosX() + 2.0F, this.getPosY() + 3.0F, AGuiLib.CONFIG.getTextColor(), false);
