...
import net.aeronica.modlibs.aguilib.proxy.ClientProxy;
import net.aeronica.modlibs.aguilib.server.property.IFloatRangeProperty;
import net.aeronica.modlibs.aguilib.server.property.IStringProperty;
...
public class SliderElement<T extends IElementGUI, P extends IFloatRangeProperty & IStringProperty> extends Element<T> {
    ...
    public void render(float mouseX, float mouseY, float partialTicks) {
        ...
        this.drawRectangle(posX, posY, width, height, this.editable ? AGuiLib.CONFIG.getSecondaryColor() : AGuiLib.CONFIG.getSecondarySubcolor());
        ...
        this.drawRectangle(posX + width - 11 - this.sliderWidth, posY, 11, 6, this.editable ? upperSelected ? AGuiLib.CONFIG.getDarkAccentColor() : AGuiLib.CONFIG.getAccentColor() : AGuiLib.CONFIG.getTertiaryColor());
        this.drawRectangle(posX + width - 11 - this.sliderWidth, posY + 6, 11, 6, this.editable ? lowerSelected ? AGuiLib.CONFIG.getDarkAccentColor() : AGuiLib.CONFIG.getAccentColor() : AGuiLib.CONFIG.getTertiaryColor());
        int textColor = AGuiLib.CONFIG.getTextColor();
        ...
        if (this.hasSlider) {
            ...
            this.drawRectangle(this.getPosX() + 38 + offsetX, this.getPosY(), 4, this.getHeight(), this.editable ? indicatorSelected ? AGuiLib.CONFIG.getDarkAccentColor() : AGuiLib.CONFIG.getAccentColor() : AGuiLib.CONFIG.getTertiaryColor());
        }
    }
