...
public class ScrollbarElement<T extends IElementGUI> extends Element<T> {
    ...
    public void render(float mouseX, float mouseY, float partialTicks) {
        if (this.maxScroll > 0) {
            this.drawRectangle(this.getPosX(), this.getPosY(), this.getWidth(), this.getHeight() - 3, this.scrolling ? AGuiLib.CONFIG.getAccentColor() : AGuiLib.CONFIG.getSecondaryColor());
        }
