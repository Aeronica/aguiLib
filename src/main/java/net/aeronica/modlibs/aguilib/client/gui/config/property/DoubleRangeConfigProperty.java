...
import net.aeronica.modlibs.aguilib.server.property.IDoubleRangeProperty;
import net.aeronica.modlibs.aguilib.server.property.wrapper.DoubleRangePropertyWrapper;
