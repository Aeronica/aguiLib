...
import net.aeronica.modlibs.aguilib.Reference;
import net.aeronica.modlibs.aguilib.client.gui.ElementGUI;
import net.aeronica.modlibs.aguilib.client.gui.config.property.ForgeConfigProperty;
import net.aeronica.modlibs.aguilib.client.gui.element.ButtonElement;
import net.aeronica.modlibs.aguilib.client.gui.element.Element;
import net.aeronica.modlibs.aguilib.client.gui.element.LabelElement;
import net.aeronica.modlibs.aguilib.client.gui.element.ListElement;
import net.aeronica.modlibs.aguilib.client.gui.element.color.ColorScheme;
...
{
    public static final ColorScheme RETURN = ColorScheme.create(() -> AGuiLib.CONFIG.getPrimaryColor(), () -> AGuiLib.CONFIG.getSecondaryColor());
    public static final ColorScheme SIDEBAR = ColorScheme.create(() -> AGuiLib.CONFIG.getPrimaryColor(), () -> AGuiLib.CONFIG.getTertiaryColor());
    public static final ResourceLocation SETTINGS_ICON = new ResourceLocation(Reference.MOD_ID, "textures/gui/settings.png");
    ...
    public int getTopBackgroundColor() {
        return AGuiLib.CONFIG.getPrimaryColor();
    }

    public int getContentBackgroundColor() {
        return AGuiLib.CONFIG.getColorMode().equals("dark") ? 0xFF191919 : 0xFFFFFFFF;
    }
    ...
    public int getTextColor() {
        return AGuiLib.CONFIG.getTextColor();
    }
