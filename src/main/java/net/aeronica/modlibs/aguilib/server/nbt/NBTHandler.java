package net.aeronica.modlibs.aguilib.server.nbt;


import net.aeronica.modlibs.aguilib.AGuiLib;
import net.aeronica.modlibs.aguilib.server.nbt.parser.INBTParser;
import net.aeronica.modlibs.aguilib.server.nbt.parser.NBTParsers;
...
public enum NBTHandler {
    ...
    private Method resolveMutator(Class<?> clazz, String name, Class<?>... param) {
        ...
        if (method == null) {
            ...
            AGuiLib.LOGGER.fatal(new RuntimeException(message));
            return null;
        }
